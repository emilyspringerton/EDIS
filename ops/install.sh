...
#   6. Start services
#
# After DNS is set (edis.fatbaby.io → 198.58.107.85), run:
...
# EDIS bootstrap — HTTP only until certbot runs
...
echo ""
echo "╔══════════════════════════════════════════════════════════════╗"
echo "║  EDIS WordPress is LIVE on HTTP                             ║"
echo "╠══════════════════════════════════════════════════════════════╣"
printf "║  URL:        http://%-42s║\n" "${DOMAIN}"
printf "║  Admin:      http://%-42s║\n" "${DOMAIN}/wp-admin/"
printf "║  User:       %-47s║\n" "${WP_ADMIN_USER}"
printf "║  Pass:       %-47s║\n" "${WP_ADMIN_PASS}"
echo "╠══════════════════════════════════════════════════════════════╣"
...
echo "    edis.fatbaby.io     →  198.58.107.85"
echo "    www.edis.fatbaby.io →  198.58.107.85"
echo ""
